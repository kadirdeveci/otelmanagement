		...
		<tr>
			<td valign="top" style="border:1px solid #dedede">
				...
				<tr>
					...
					<td><input class="mgrid_text" name="page_title" id="frmPage_page_title" value="<?php echo $objPage->GetTitle();?>" size="45" maxlength="255"></td>
				</tr>				
				<tr>
					<td><?php echo _MENU_LINK_TEXT;?>:</td>
					<td><input class="mgrid_text" name="menu_link" value="<?php echo $objPage->GetMenuLink();?>" size="45" maxlength="40"></td>
				</tr>
				...
				<tr>
					...
					<td>
						<input class="mgrid_text" name="system_page" value="<?php echo $objPage->GetParameter('system_page');?>" size="30" maxlength="50">
					</td>
				</tr>
				<?php } ?>		
				...
				<tr id="link_row_1" style="display:none;">
					...
					<td><input class="mgrid_text" name="link_url" id="frmPage_link_url" value="<?php echo $objPage->GetParameter('link_url');?>" size="50" maxlength="255" /></td>
				</tr>
				...
				<tr id="row_meta_2" style="display:none;">
					...
					<td>
						<textarea class="mgrid_text" name="tag_title" id="frmPage_tag_title" style="width:470px" rows="1"><?php echo $objPage->GetParameter('tag_title'); ?></textarea>
					</td>
				</tr>
				<tr id="row_meta_3" style="display:none;">
					<td><?php echo _META_TAG;?> &lt;KEYWORDS&gt;:</td>
					<td>
						<textarea class="mgrid_text" name="tag_keywords" id="frmPage_tag_keywords" style="width:470px" rows="2"><?php echo $objPage->GetParameter('tag_keywords'); ?></textarea>
					</td>
				</tr>
				<tr id="row_meta_4" style="display:none;">
					<td><?php echo _META_TAG;?> &lt;DESCRIPTION&gt;:</td>
					<td>
						<textarea class="mgrid_text" name="tag_description" id="frmPage_tag_description" style="width:470px" rows="2"><?php echo $objPage->GetParameter('tag_description'); ?></textarea>
					</td>
				</tr>
				<tr><td colspan="2" height="10px"></td></tr>
				...
				<tr id="page_row_1">
					...
					<td style="<?php echo $button_align;?>">
						<input class="mgrid_button mgrid_button_cancel" type="button" name="butCancel" value="<?php echo _BUTTON_CANCEL; ?>" onclick="Cancel()">&nbsp;&nbsp;			
						<input class="mgrid_button" type="submit" name="subSavePage" value="<?php echo _BUTTON_SAVE_CHANGES ?>">
					</td>
				</tr>
			...
			<td valign="top" style="width:270px;border:1px solid #dedede">
				...
				<?php if(Application::Get('page_id') != 'home'){ ?>	
					<tr>
						...
						<td colspan="2">
							<input class="mgrid_text" name="priority_order" value="<?php echo ($objPage->GetParameter('priority_order') == '') ? '0' : $objPage->GetParameter('priority_order'); ?>" size="2" maxlength="4" />
						</td>
					</tr>
				...
				<?php if(Application::Get('page_id') != 'home' && Application::Get('type') != 'system'){ ?>
                    <tr>
                        ...
                        <td colspan="2">
                            <input class="mgrid_text" name="finish_publishing" id="frmPage_finish_publishing" value="<?php echo format_datetime($objPage->GetParameter('finish_publishing'), 'Y-m-d', _NEVER); ?>" size="8" maxlength="10" />
