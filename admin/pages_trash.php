...
?>
	...
	?>
		...
		<tr>
			<th class="align_left" align="<?php echo Application::Get('defined_left'); ?>"><?php echo _PAGE_HEADER;?></th>
			<th class="align_center" width="20%"><?php echo _MENU_WORD;?></th>
			<th class="align_center" width="18%" nowrap="nowrap" align="center"><?php echo _REMOVED;?></th>
			<th class="align_center" width="15%" nowrap="nowrap"><?php echo _CONTENT_TYPE;?></th>
			<?php
