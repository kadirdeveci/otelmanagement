		...
		<tr>
			<td valign="top" style="border:1px solid #dedede">
				...
				<tr id="row_meta_2" style="display:none;">
					...
					<td>
						<textarea class="mgrid_textarea" name="tag_title" id="frmPage_tag_title" style="width:470px" rows="1"><?php echo $tag_title; ?></textarea>
					</td>
				</tr>
				<tr id="row_meta_3" style="display:none;">
					<td><?php echo _META_TAG;?> &lt;KEYWORDS&gt;:</td>
					<td>
						<textarea class="mgrid_textarea" name="tag_keywords" id="frmPage_tag_keywords" style="width:470px" rows="2"><?php echo $tag_keywords; ?></textarea>
					</td>
				</tr>
				<tr id="row_meta_4" style="display:none;">
					<td><?php echo _META_TAG;?> &lt;DESCRIPTION&gt;:</td>
					<td>
						<textarea class="mgrid_textarea" name="tag_description" id="frmPage_tag_description" style="width:470px" rows="2"><?php echo $tag_description; ?></textarea>
					</td>
				</tr>
				<tr><td colspan="2" height="10px"></td></tr>
				...
				<tr id="page_row_1">
					...
					<td style="<?php echo $button_align;?>">
						...
						<input class="mgrid_button" type="submit" name="subSavePage" value="<?php echo _BUTTON_CREATE; ?>">
					</td>
				</tr>
			...
			<td valign="top" style="width:270px;border:1px solid #dedede">
				...
				<tr>
					...
					<td colspan="2">
						<input class="mgrid_text" name="priority_order" id="frmPage_priority_order" value="<?php echo $priority_order; ?>" size="2" maxlength="4" />
					</td>			
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="2">
						<input class="mgrid_text" name="finish_publishing" id="frmPage_finish_publishing" value="<?php echo $finish_publishing; ?>" size="8" maxlength="10" />
