...
function draw_block_top($block_name = '', $ind = '', $status = 'maximized', $draw = true)
{
	...
	if($objLogin->IsLoggedInAsAdmin()){
        ...
        //$output .= '<button class="collapsebtn" data-target="#collapse3" data-toggle="collapse" type="button">'.$block_name.'<span class="collapsearrow"></span></button>';
		$output .= '<h3 class="collapsebtn side_box_heading" data-target="#collapse'.$ind.'" data-toggle="collapse">'.$block_name.'<span class="collapsearrow"></span></h3>'.$nl;
		$output .= '<div id="collapse'.$ind.'" class="side_box_content collapse in">'.$nl;
	}
