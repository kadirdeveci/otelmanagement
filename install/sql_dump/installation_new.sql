...
INSERT INTO `<DB_PREFIX>accounts` (`id`, `first_name`, `last_name`, `user_name`, `password`, `email`, `profile_photo`, `profile_photo_thumb`, `account_type`, `companies`, `preferred_language`, `oa_consumer_domain`, `oa_consumer_key`, `oa_consumer_secret`, `date_created`, `date_lastlogin`, `is_active`) VALUES
(1, 'John', 'Smith', '<USER_NAME>', <PASSWORD>, '<USER_EMAIL>', '', '', 'owner', '', 'en', '', '', '', NULL, '2013-11-21 16:21:32', 1);
...
(5, 2, 'es', '<span class="lato size28 slim caps white">Francia</span><br><br><br><span class="lato size100 slim caps white">París</span><br><span class="lato size20 normal caps white">de</span><br><br><span class="lato size48 slim uppercase yellow">$1300</span>'),
...
INSERT INTO `<DB_PREFIX>campaigns`(id, `hotel_id`, `group_id`, `campaign_type`, `campaign_name`, `start_date`, `finish_date`, `discount_percent`, `is_active`) VALUES (NULL, 1, 0, 'global', 'Campaign #4 Sep 2015', '2015-09-07', '2015-10-07', '10', '1');
...
(3, 1, 0, 'Robert', '', NULL, '', '', '', '', '', '', '', 'GB', '', '', '', 'robert@email.com', 'customer3', '', '', '', 'en', '2016-04-22 13:00:03', NULL, '127.0.0.1', '', 0, NULL, 0, 0, 0, 1, '0.00', 1, 0, '', ''),
...
(7, 'afd4vgf5yt', 'en', 'article', '', '_self', 'Gallery', 'Gallery', '<p>{module:gallery}</p>', 0, 'Gallery', 'Gallery', 'php hotel site, hotel online booking site', 'View our video and image galleries', 0, '2011-05-01 11:16:22', '2013-11-06 16:59:27', NULL, 0, 0, 1, 1, 'gallery', 1, NULL, 'public', 1),
...
(10, 'op8uy67ydd', 'en', 'article', '', '_self', 'Testimonials', 'Testimonials', '<p>{module:testimonials}</p>', 0, 'Testimonials', 'Testimonials', 'php hotel site, hotel online booking site', 'What our clients are saying', 0, '2011-05-01 11:16:22', '2013-11-06 17:01:53', NULL, 0, 0, 1, 1, 'testimonials', 1, NULL, 'public', 3),
...
(19, 's3d4fder56', 'en', 'article', '', '_self', 'About-Us', 'About Us', '<p>{module:about_us}</p>', 0, 'About Us', 'About Us', 'php hotel site, hotel online booking site', 'uHotelBooking', 0, '2011-05-01 11:16:22', '2013-11-06 17:02:02', NULL, 0, 0, 1, 1, 'about_us', 1, NULL, 'public', 4),
...
(25, 'zxcs3d4fd5', 'en', 'article', '', '_self', 'Test-Page', 'Test Page', '<p>Test page with comments</p>', 1, 'Test Page', 'Test Page', 'php hotel site, hotel online booking site', 'uHotelBooking', 1, '2011-05-01 11:16:22', '2013-11-21 19:16:15', NULL, 0, 0, 1, 0, '', 1, NULL, 'public', 1),
...
(28, 'q8mv7zrzmo', 'en', 'article', '', '_self', 'Contact-Us', 'Contact Us', '<p>{module:contact_us}</p>', 0, 'Contact Us', 'Contact Us', 'php hotel site, hotel online booking site', 'uHotelBooking', 0, '2011-05-01 11:16:22', '2013-11-06 17:02:41', NULL, 0, 0, 1, 1, 'contact_us', 1, NULL, 'public', 5),
...
(31, 'a4wg6xx1wl', 'en', 'article', '', '_self', 'Blog', 'Blog', '<h3 class="extra-wrap"><a href="#">MİLANO Ekonomik Gezi Rehberi</a></h3><p>Milano denilince ilk akla gelen kelime muhtemelen “moda”dır. Şehre adım atar atmaz çok şık insanları göreceğinizi ve adeta bir defiledeymişsiniz gibi hissedeceğinizi düşünüyorsanız yanılmıyorsunuz. Yerlisind..<a href="#">Devamını oku</a></p><br> <h3 class="extra-wrap"> <a href="#">BERGAMO Ekonomik Gezi Rehberi</a></h3><p>İtalya’nın kuzeyinde, Lombardiya bölgesi sınırları içinde, Milano’ya 50 km’lik mesafede yer alan küçük bir İtalyan şehri Bergamo. Bizim Bergamo ile tanışmamız Milano’ya ucuz uçak bilet bulmamız vesilesi ile oldu aslın..<a href="#">Devamını oku</a></p><br><h3 class="extra-wrap"><a href="#">SOFYA Ekonomik Gezi Rehberi</a></h3><p>Bulgaristan’ın başkenti ve en büyük şehri olan Sofya 7000 yıllık bir tarihe sahip ancak buna rağmen turistik olarak gezilecek çok fazla yer bulunmuyor. Popüler bir kayak merkezi olan Vitoşha dağı, uygun fiyatlı yeme içme olanakları, casi..<a href="#">Devamını oku</a></p><br><h3 class="extra-wrap"><a href="#">KOTOR Ekonomik Gezi Rehberi</a></h3><p>Uzun zamandır yapmak istediğimiz Balkan turumuzun en güzel duraklarından bir tanesi Kotor oldu. Şehirde geçirdiğimiz 2-3 saatlik zaman, turistik olarak gayet yeterli olmasına rağmen, bu şehrin masalsı havasına doyamadık. Yol boyu..<a href="#">Devamını oku</a></p>', 0, 'Blog', 'Blog', 'php hotel site, hotel online booking site', 'uHotelBooking', 0, '2011-05-01 11:16:22', '2013-11-06 17:02:41', NULL, 0, 0, 1, 1, 'blog', 1, NULL, 'public', 10),
(32, 'a4wg6xx1wl', 'es', 'article', '', '_self', 'Blog', 'Blog', '<h3 class="extra-wrap"><a href="#">MİLANO Ekonomik Gezi Rehberi</a></h3><p>Milano denilince ilk akla gelen kelime muhtemelen “moda”dır. Şehre adım atar atmaz çok şık insanları göreceğinizi ve adeta bir defiledeymişsiniz gibi hissedeceğinizi düşünüyorsanız yanılmıyorsunuz. Yerlisind..<a href="#">Devamını oku</a></p><br> <h3 class="extra-wrap"> <a href="#">BERGAMO Ekonomik Gezi Rehberi</a></h3><p>İtalya’nın kuzeyinde, Lombardiya bölgesi sınırları içinde, Milano’ya 50 km’lik mesafede yer alan küçük bir İtalyan şehri Bergamo. Bizim Bergamo ile tanışmamız Milano’ya ucuz uçak bilet bulmamız vesilesi ile oldu aslın..<a href="#">Devamını oku</a></p><br><h3 class="extra-wrap"><a href="#">SOFYA Ekonomik Gezi Rehberi</a></h3><p>Bulgaristan’ın başkenti ve en büyük şehri olan Sofya 7000 yıllık bir tarihe sahip ancak buna rağmen turistik olarak gezilecek çok fazla yer bulunmuyor. Popüler bir kayak merkezi olan Vitoşha dağı, uygun fiyatlı yeme içme olanakları, casi..<a href="#">Devamını oku</a></p><br><h3 class="extra-wrap"><a href="#">KOTOR Ekonomik Gezi Rehberi</a></h3><p>Uzun zamandır yapmak istediğimiz Balkan turumuzun en güzel duraklarından bir tanesi Kotor oldu. Şehirde geçirdiğimiz 2-3 saatlik zaman, turistik olarak gayet yeterli olmasına rağmen, bu şehrin masalsı havasına doyamadık. Yol boyu..<a href="#">Devamını oku</a></p>', 0, 'Blog', 'Blog', 'php sitio del hotel, sitio de reserva de hotel en línea', 'uHotelBooking', 0, '2011-05-01 11:16:22', '2013-11-21 19:22:07', NULL, 0, 0, 1, 1, 'blog', 1, NULL, 'public', 10),
(33, 'a4wg6xx1wl', 'de', 'article', '', '_self', 'Blog', 'Blog Sie uns', '<h3 class="extra-wrap"><a href="#">MİLANO Ekonomik Gezi Rehberi</a></h3><p>Milano denilince ilk akla gelen kelime muhtemelen “moda”dır. Şehre adım atar atmaz çok şık insanları göreceğinizi ve adeta bir defiledeymişsiniz gibi hissedeceğinizi düşünüyorsanız yanılmıyorsunuz. Yerlisind..<a href="#">Devamını oku</a></p><br> <h3 class="extra-wrap"> <a href="#">BERGAMO Ekonomik Gezi Rehberi</a></h3><p>İtalya’nın kuzeyinde, Lombardiya bölgesi sınırları içinde, Milano’ya 50 km’lik mesafede yer alan küçük bir İtalyan şehri Bergamo. Bizim Bergamo ile tanışmamız Milano’ya ucuz uçak bilet bulmamız vesilesi ile oldu aslın..<a href="#">Devamını oku</a></p><br><h3 class="extra-wrap"><a href="#">SOFYA Ekonomik Gezi Rehberi</a></h3><p>Bulgaristan’ın başkenti ve en büyük şehri olan Sofya 7000 yıllık bir tarihe sahip ancak buna rağmen turistik olarak gezilecek çok fazla yer bulunmuyor. Popüler bir kayak merkezi olan Vitoşha dağı, uygun fiyatlı yeme içme olanakları, casi..<a href="#">Devamını oku</a></p><br><h3 class="extra-wrap"><a href="#">KOTOR Ekonomik Gezi Rehberi</a></h3><p>Uzun zamandır yapmak istediğimiz Balkan turumuzun en güzel duraklarından bir tanesi Kotor oldu. Şehirde geçirdiğimiz 2-3 saatlik zaman, turistik olarak gayet yeterli olmasına rağmen, bu şehrin masalsı havasına doyamadık. Yol boyu..<a href="#">Devamını oku</a></p>', 0, 'Kontakt', 'Blog Sie uns', 'php Hotel Website, Hotel online buchen Website', 'uHotelBooking', 0, '2011-05-01 11:16:22', '2013-11-21 19:23:52', NULL, 0, 0, 1, 1, 'blog', 1, NULL, 'public', 10);
...
(0, 'default', 'vertical', 0, 0, 'mm/dd/yyyy', '0', 'american', 1, 'info@yourdomain.com', '', 'php', 'php_mail_standard', 'none', 'ssl', '', '', '', '', 'tinymce', 1, 'rss2', '90-54-48-19-16-13-10-7-4-1', 0, 0, 5, 'Our website is currently offline for maintenance. Please visit us later.', '-1', '0', 'stop', '2013-11-21 16:21:27', 'hour', 24);
...
(1, 'en', 'uHotelBooking', 'your slogan here...', 'uHotelBooking © <a class="footer_link" target="_blank" rel="noopener noreferrer" href="http://www.hotel-booking-script.com/index.php">ApPHP</a>', 'uHotelBooking', 'uHotelBooking', 'php hotel script, hotel online booking site', ''),
...
CREATE TABLE IF NOT EXISTS `<DB_PREFIX>vocabulary` (
  ...
  KEY `language_id` (`language_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=5165 ;
...
(3450, 'en', '_OFFLINE_LOGIN_ALERT', 'To log into Admin Panel when site is offline, type in your browser: http://{your_site_address}/index.php?admin=<ADMIN_LOGIN>'),
(3451, 'es', '_OFFLINE_LOGIN_ALERT', 'Para entrar en el panel de administración cuando el sitio está en línea, escriba en su navegador: http:// {your_site_address}/index.php?admin=<ADMIN_LOGIN>'),
...
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_SORRY_WE_COULD_NOT_FIND', '<h3>Sorry—we couldn''t find<br/>_QUERY_</h3>You could try:<br/><ul><li>Searching a different area</li><li>A more general search (hotel, landmark, location)</li><li>Checking your spelling</li>'), (NULL, 'es', '_SORRY_WE_COULD_NOT_FIND', '<h3>Lo sentimos, pero no hemos encontrado<br/>_QUERY_</h3>Usted podría intentar:<br/><ul><li>Búsqueda en un área diferente</li><li>Una búsqueda más general (hotel, lugar de interés, ubicación)</li><li>Comprobación de la ortografía</li>'), (NULL, 'de', '_SORRY_WE_COULD_NOT_FIND', '<h3>Leider konnten wir nicht finden<br/>_QUERY_</h3>Sie könnten versuchen:<br/><ul><li>Suche nach einem anderen Gebiet</li><li>Eine allgemeinere Suche (Hotel, Sehenswürdigkeit, Standort)</li><li>Rechtschreibprüfung</li>');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_MESSAGE_DISCOUNTS_GUESTS', 'The price of the room depends on the total number of guests when ordering.<br/>Price per room when ordering for 3 people _PRICE_3_PEOPLE_<br/>Price per room when ordering for 4 people _PRICE_4_PEOPLE_<br/>Price per room when ordering for 5 or more people _PRICE_5_PEOPLE_'), (NULL, 'es', '_MESSAGE_DISCOUNTS_GUESTS', 'El precio de la habitación depende del número total de huéspedes al hacer el pedido. <br/> Precio por habitación en el pedido para 3 personas _PRICE_3_PEOPLE_<br/> Precio por habitación en el pedido para 4 personas _PRICE_4_PEOPLE_<br/> Precio por habitación en el pedido de 5 o más personas _PRICE_5_PEOPLE_'), (NULL, 'de', '_MESSAGE_DISCOUNTS_GUESTS', 'Der Preis des Zimmers hängt von der Gesamtzahl der Gäste bei der Bestellung ab. <br/> Preis pro Zimmer bei der Bestellung für 3 Personen _PRICE_3_PEOPLE_<br/> Preis pro Zimmer bei der Bestellung für 4 Personen _PRICE_4_PEOPLE_<br/> Preis pro Zimmer bei der Bestellung für 5 Oder mehr Menschen _PRICE_5_PEOPLE_');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_QUICK_RESERVATIONS', 'Quick Reservations'), (NULL, 'es', '_QUICK_RESERVATIONS', 'Reservas rápidas'), (NULL, 'de', '_QUICK_RESERVATIONS', 'Schnelle Reservierungen');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_EXISTING_ROOM_TYPES', 'Existent room type'), (NULL, 'es', '_EXISTING_ROOM_TYPES', 'El tipo de habitación existente'), (NULL, 'de', '_EXISTING_ROOM_TYPES', 'Bestehende Zimmertyp');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_NO_AVAILABLE_ROOMS', 'At this time there are no available rooms of this type'), (NULL, 'es', '_NO_AVAILABLE_ROOMS', 'En este momento no hay habitaciones disponibles de este tipo'), (NULL, 'de', '_NO_AVAILABLE_ROOMS', 'Zur Zeit sind keine Zimmer dieses Typs verfügbar');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_THIS_HOTEL_NO_ROOMS', 'There are no rooms defined in this hotel.'), (NULL, 'es', '_THIS_HOTEL_NO_ROOMS', 'En este hotel no tiene habitaciones.'), (NULL, 'de', '_THIS_HOTEL_NO_ROOMS', 'In diesem Hotel keine Zimmer.');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_PLEASE_SELECT_ROOM', 'Please select a room from the list'), (NULL, 'es', '_PLEASE_SELECT_ROOM', 'Por favor, seleccione hoja de Rohm and Frome Tkhe'), (NULL, 'de', '_PLEASE_SELECT_ROOM', 'Bitte wählen Sie Rohm and Frome Tkhe Blatt');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_PLEASE_SELECT_NUMBER_ROOMS', 'Please select a number of rooms (in the Hotel) from the list'), (NULL, 'es', '_PLEASE_SELECT_NUMBER_ROOMS', 'Por favor, seleccione un número de la ROPME (Eun Tae Se busca) Hoja de Frome Tkhe'), (NULL, 'de', '_PLEASE_SELECT_NUMBER_ROOMS', 'Bitte wählen Sie aus der Liste eine Anzahl Zimmer (im Hotel) aus');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_APPLY_FILTERS', 'Apply The Filters'), (NULL, 'es', '_APPLY_FILTERS', 'Aplicar los filtros'), (NULL, 'de', '_APPLY_FILTERS', 'Übernehmen Sie die Filter');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_YOU_HAVE_RESERVED', 'You have reserved _NUMBER_ROOMS_ _ROOMS_ for a total of _PRICE_'), (NULL, 'es', '_YOU_HAVE_RESERVED', 'Has reservado _NUMBER_ROOMS_  _ROOMS_ por un total de _PRICE_'), (NULL, 'de', '_YOU_HAVE_RESERVED', 'Sie haben _NUMBER_ROOMS_ _ROOMS_ für insgesamt _PRICE_ reserviert');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_MSG_MAXIMUM_PRICE', 'The maximum price in the _FIELD_ field should not exceed _SUM_'), (NULL, 'es', '_MSG_MAXIMUM_PRICE', 'El precio máximo en el campo _FIELD_ no debe exceder _SUM_'), (NULL, 'de', '_MSG_MAXIMUM_PRICE', 'Der Höchstpreis im Feld _FIELD_ darf _SUM_ nicht überschreiten');

INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_RECOMMENDED_IMAGE_SIZE', 'Recommended image size of _SIZE_'), (NULL, 'es', '_RECOMMENDED_IMAGE_SIZE', 'Tamaño de imagen recomendado de _SIZE_'), (NULL, 'de', '_RECOMMENDED_IMAGE_SIZE', 'Empfohlene Bildgröße von _SIZE_');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_MY_AGENCIES', 'My Agencies'), (NULL, 'es', '_MY_AGENCIES', 'Mis Agencias'), (NULL, 'de', '_MY_AGENCIES', 'Meine Agenturen');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_HOTELS_LOCATION', 'Hotels location'), (NULL, 'es', '_HOTELS_LOCATION', 'Hoteles ubicación'), (NULL, 'de', '_HOTELS_LOCATION', 'Übernachtung');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_CENTER_PANEL', 'Center Panel'), (NULL, 'es', '_CENTER_PANEL', 'Panel central'), (NULL, 'de', '_CENTER_PANEL', 'Zentriertafel');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_DISPLAYS_AVAILABILITY_CALENDAR', 'Displays the availability calendar of the room for each month'), (NULL, 'es', '_DISPLAYS_AVAILABILITY_CALENDAR', 'Muestra el calendario de disponibilidad de la habitación para cada mes'), (NULL, 'de', '_DISPLAYS_AVAILABILITY_CALENDAR', 'Zeigt den Verfügbarkeitskalender des Raumes für jeden Monat an');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_AVAILABLE_CALENDAR', 'Availability Calendar'), (NULL, 'es', '_AVAILABLE_CALENDAR', 'Calendario de disponibilidad'), (NULL, 'de', '_AVAILABLE_CALENDAR', 'Verfügbarkeitskalender');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_MEAL_DESCRIPTION', 'Meals are charged per night of stay and per person'), (NULL, 'es', '_MEAL_DESCRIPTION', 'Las comidas se cobran por noche de estancia y por persona'), (NULL, 'de', '_MEAL_DESCRIPTION', 'Die Mahlzeiten werden pro Übernachtung und pro Person berechnet');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_MSG_WIDGET_CENTER_PANEL_HOME', 'Set the parameters to get a list of available rooms'), (NULL, 'es', '_MSG_WIDGET_CENTER_PANEL_HOME', 'Establezca los parámetros para obtener una lista de habitaciones disponibles'), (NULL, 'de', '_MSG_WIDGET_CENTER_PANEL_HOME', 'Stellen Sie die Parameter ein, um eine Liste der verfügbaren Räume zu erhalten');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_FIELD_DAYS_INCORRECT_VALUE', 'The field days has incorrect value: _DAY_. The number of rooms that you want to make available should not exceed the number of closed rooms.'), (NULL, 'es', '_FIELD_DAYS_INCORRECT_VALUE', 'Los días de campo tienen un valor incorrecto: _DAY_. El número de habitaciones que desea poner a disposición no debe exceder el número de habitaciones cerradas.'), (NULL, 'de', '_FIELD_DAYS_INCORRECT_VALUE', 'Die Feldtage haben einen falschen Wert: _DAY_. Die Anzahl der Zimmer, die Sie zur Verfügung stellen möchten, sollte die Anzahl der geschlossenen Räume nicht überschreiten.');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_CLOSED_ROOMS', 'Closed Rooms'), (NULL, 'es', '_CLOSED_ROOMS', 'Habitaciones cerradas'), (NULL, 'de', '_CLOSED_ROOMS', 'Geschlossene Räume');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_NOT_POSSIBLE_BOOKING', 'Not possible to booking {_ROOM_TYPE_} room. You are trying to reserve {_NUM_BOOK_} but there are only {_NUM_AVAL_}'), (NULL, 'es', '_NOT_POSSIBLE_BOOKING', 'No es posible reservar {_ROOM_TYPE_} habitación. Intentas reservar {_NUM_BOOK_} pero solo hay {_NUM_AVAL_}'), (NULL, 'de', '_NOT_POSSIBLE_BOOKING', 'Es ist nicht möglich, Zimmer {_ROOM_TYPE_} zu buchen. Sie versuchen, {_NUM_BOOK_} zu reservieren, aber es gibt nur {_NUM_AVAL_}');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_GEOGRAPHICAL_ADDRESS', 'Website Geographical Address'), (NULL, 'es', '_GEOGRAPHICAL_ADDRESS', 'Dirección geográfica del sitio web'), (NULL, 'de', '_GEOGRAPHICAL_ADDRESS', 'Website Geographische Adresse');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_PC_MESSAGE_FOOTER', 'additional information: header text, contact email, geographical address etc.'), (NULL, 'es', '_PC_MESSAGE_FOOTER', 'Información adicional: texto del encabezado, correo electrónico de contacto, dirección geográfica, etc.'), (NULL, 'de', '_PC_MESSAGE_FOOTER', 'Zusätzliche Informationen: Kopfzeile, Kontakt-E-Mail, geografische Anschrift etc.');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_RESERVED_ROOMS', 'Reserved Rooms'), (NULL, 'es', '_RESERVED_ROOMS', 'Habitaciones Reservadas'), (NULL, 'de', '_RESERVED_ROOMS', 'Reservierte Zimmer');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_REGIONAL_MANAGER_COMMENT_ADD', 'Add a comment'), (NULL, 'es', '_REGIONAL_MANAGER_COMMENT_ADD', 'Añadir un comentario'), (NULL, 'de', '_REGIONAL_MANAGER_COMMENT_ADD', 'Einen Kommentar hinzufügen');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_REGIONAL_MANAGER_COMMENT_EDIT', 'Edit a comment'), (NULL, 'es', '_REGIONAL_MANAGER_COMMENT_EDIT', 'Editar un comentario'), (NULL, 'de', '_REGIONAL_MANAGER_COMMENT_EDIT', 'Bearbeiten Sie einen Kommentar');

INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_APPLICATION_MODULES', 'Application Modules'), (NULL, 'es', '_APPLICATION_MODULES', 'Módulos de Aplicación'), (NULL, 'de', '_APPLICATION_MODULES', 'Anwendungsmodule');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_MODULE_ALREADY_INSTALLED', 'This module is already installed!'), (NULL, 'es', '_MODULE_ALREADY_INSTALLED', '¡Este módulo ya está instalado!'), (NULL, 'de', '_MODULE_ALREADY_INSTALLED', 'Dieses Modul ist bereits installiert!');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_MODULE_NOT_FOUND', 'This module is not found!'), (NULL, 'es', '_MODULE_NOT_FOUND', 'Este módulo no se encuentra'), (NULL, 'de', '_MODULE_NOT_FOUND', 'Dieses Modul wurde nicht gefunden!');

INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_CANCELLATION_POLICY_FOR_ROOM', 'Cancellation policy for the room'), (NULL, 'es', '_CANCELLATION_POLICY_FOR_ROOM', 'Política de cancelación de la habitación'), (NULL, 'de', '_CANCELLATION_POLICY_FOR_ROOM', 'Stornierungsbedingungen für das Zimmer');

INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_MODULE_TYPE', 'Module Type'), (NULL, 'es', '_MODULE_TYPE', 'Module Type'), (NULL, 'de', '_MODULE_TYPE', 'Module Type');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_APPLICATION', 'Application'), (NULL, 'es', '_APPLICATION', 'Solicitud'), (NULL, 'de', '_APPLICATION', 'Anwendung');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_ADDITIONAL', 'Additional'), (NULL, 'es', '_ADDITIONAL', 'Adicional'), (NULL, 'de', '_ADDITIONAL', 'Zusätzlich');

INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_PRICE_DETAILS', 'Price Details'), (NULL, 'es', '_PRICE_DETAILS', 'Detalles del precio'), (NULL, 'de', '_PRICE_DETAILS', 'Preisdetails');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_TO_MAKE_YOUR_RESERVATION', 'To make your reservation, please enter the desired dates and number of guests on the left then press the "Check availability" button.'), (NULL, 'es', '_TO_MAKE_YOUR_RESERVATION', 'Para hacer su reserva, introduzca las fechas y el número de invitados a la izquierda y pulse el botón "Verificar disponibilidad".'), (NULL, 'de', '_TO_MAKE_YOUR_RESERVATION', 'Um Ihre Reservierung vorzunehmen, geben Sie bitte das gewünschte Datum und die Anzahl der Gäste auf der linken Seite ein und klicken Sie dann auf die Schaltfläche "Verfügbarkeit prüfen".');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_SELECT_DATES_REQUIRED', 'Select dates and accomodations required'), (NULL, 'es', '_SELECT_DATES_REQUIRED', 'Seleccione fechas y alojamiento'), (NULL, 'de', '_SELECT_DATES_REQUIRED', 'Wählen Sie die gewünschten Daten und Unterkünfte aus');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_WHY_SHOULD_I_BOOK', 'Why should I book online?'), (NULL, 'es', '_WHY_SHOULD_I_BOOK', '¿Por qué reservar en línea?'), (NULL, 'de', '_WHY_SHOULD_I_BOOK', 'Warum sollte ich online buchen?');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_BEST_RATE_GUARANTEED', 'Best rate Guaranteed'), (NULL, 'es', '_BEST_RATE_GUARANTEED', 'Mejor Tarifa Garantizada'), (NULL, 'de', '_BEST_RATE_GUARANTEED', 'Best Rate Garantiert');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_BOOK_NOW_PAY_LATER', 'Book now, pay later'), (NULL, 'es', '_BOOK_NOW_PAY_LATER', 'Reserva ahora y paga después'), (NULL, 'de', '_BOOK_NOW_PAY_LATER', 'Buchen Sie jetzt, zahlen Sie später');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_DIRECT_RESERVATION', 'Direct reservation with hotel, No booking fees'), (NULL, 'es', '_DIRECT_RESERVATION', 'Reserva directa con hotel, Sin gastos de reserva'), (NULL, 'de', '_DIRECT_RESERVATION', 'Direkte Reservierung mit dem Hotel, Keine Buchungsgebühren');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_FREE_CANCELLATION', 'Free cancellation within terms'), (NULL, 'es', '_FREE_CANCELLATION', 'Cancelación gratuita dentro de los plazos'), (NULL, 'de', '_FREE_CANCELLATION', 'Kostenlose Stornierung innerhalb von Begriffen');
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_RECREATE', 'Recreate'), (NULL, 'es', '_RECREATE', 'Rekreate'), (NULL, 'de', '_RECREATE', 'Rekreate');

INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_MESSAGE_FOR_RECREATE', 'Are you sure want to recreate API key?'), (NULL, 'es', '_MESSAGE_FOR_RECREATE', '¿Seguro que quieres volver a crear la clave de la API?'), (NULL, 'de', '_MESSAGE_FOR_RECREATE', 'Möchten Sie API-Schlüssel wirklich neu erstellen?');

INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_HOTEL_WITH_BEST_PRICE', 'Hotel with the best price'), (NULL, 'es', '_HOTEL_WITH_BEST_PRICE', 'Hotel con el mejor precio'), (NULL, 'de', '_HOTEL_WITH_BEST_PRICE', 'Hotel mit dem besten Preis');
...
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_BEST_PRICE', 'the best price'), (NULL, 'es', '_BEST_PRICE', 'el mejor precio'), (NULL, 'de', '_BEST_PRICE', 'der beste Preis');
...
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES (NULL, 'en', '_FIELD_INCORRECT_VALUE', 'The field _FIELD_ has incorrect value! Please re-enter.'), (NULL, 'es', '_FIELD_INCORRECT_VALUE', 'El campo _FIELD_ tiene valor incorrecto! Vuelve a ingresar.'), (NULL, 'de', '_FIELD_INCORRECT_VALUE', 'Das Feld _FIELD_ hat falschen Wert! Bitte erneut eingeben.');
...
-- 08/10/2017 --
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES
(NULL, 'en', '_FLATS_ADMIN_WELCOME_TEXT', '<p>Welcome to Administrator Control Panel that allows you to add, edit or delete site content. With this Administrator Control Panel you can easy manage customers, reservations and perform a full hotel site management.</p><p><b>&#8226;</b> There are some modules for you: Backup & Restore, News. Installation or un-installation of them is possible from <a href=''index.php?admin=modules''>Modules Menu</a>.</p><p><b>&#8226;</b> In <a href=''index.php?admin=languages''>Languages Menu</a> you may add/remove language or change language settings and edit your vocabulary (the words and phrases, used by the system).</p><p><b>&#8226;</b> <a href=''index.php?admin=settings''>Settings Menu</a> allows you to define important settings for the site.</p><p><b>&#8226;</b> In <a href=''index.php?admin=my_account''>My Account</a> there is a possibility to change your info.</p><p><b>&#8226;</b> <a href=''index.php?admin=menus''>Menus</a> and <a href=''index.php?admin=pages''>Pages Management</a> are designed for creating and managing menus, links and pages.</p><p><b>&#8226;</b> To create and edit room types, seasons, prices, bookings and other flats info, use <a href=''index.php?admin=hotels_info''>Flats Management</a> and <a href=''index.php?admin=mod_booking_bookings''>Bookings</a> menus.</p>'),
(NULL, 'es', '_FLATS_ADMIN_WELCOME_TEXT', '<p>Bienvenido al Administrador del panel de control que le permite agregar, editar o eliminar contenido del sitio. Con este Panel de Control del Administrador usted puede fácilmente administrar clientes, reservas y realizar una gestión hotelera de todo el sitio.</p>\r\n<p><b>&#8226;</b> Hay algunos módulos para usted: Copia de seguridad y restauración, Noticias. La instalación o desinstalación de ellos es posible de <a href=''index.php?admin=modules''>módulos Menú</a>.</p>\r\n<p><b>&#8226;</b> En <a href=''index.php?admin=languages''>Idiomas del menú</a> que puede agregar o quitar idioma o cambiar la configuración de idioma y modificar su vocabulario (las palabras y frases, utilizadas por el sistema).</p>\r\n<p><b>&#8226;</b> <a href=''index.php?admin=settings''>menú de configuración</a> le permite definir opciones importantes para el sitio.</p>\r\n<p><b>&#8226;</b> En <a href=''index.php?admin=my_account''>Mi Cuenta</a> hay una posibilidad de cambiar su información.</p>\r\n<p><b>&#8226;</b> <a href=''index.php?admin=menus''>menús</a> y <a href=''index.php?admin=pages''>Páginas de Gestión</a> están diseñados para crear y gestionar los menús, enlaces y páginas. </p>\r\n<p><b>&#8226;</b> Para crear y editar tipos de habitación, temporadas, precios, reservas y otros datos del pisos, el uso <a href=''index.php?admin=hotels_info''>Pisos Management</a> y <a href=''index.php?admin=mod_booking_bookings''>reservas</a> menús.</p>'),
(NULL, 'de', '_FLATS_ADMIN_WELCOME_TEXT', '<p>Willkommen Administrator Control Panel, mit dem Sie hinzufügen, bearbeiten oder löschen Website-Content. Mit dieser Administrator Control Panel können Sie einfach verwalten Kunden, Reservierungen und eine vollständige Hotel Bauleitung.</p><p><b>•</b> Es gibt einige Module für Sie: Backup & Restore, News. Installation oder Deinstallation von ihnen ist möglich aus <a href=''index.php?admin=modules''>Module Menu</a>.</p><p><b>•</b> Im <a href=''index.php?admin=languages''>Menü Sprachen</a> Sie können hinzufügen / entfernen oder ändern Sprache Sprache ändern und bearbeiten Sie Ihren Wortschatz (die Wörter und Sätze, die vom System verwendet).</p><p><b>•</b> <a href=''index.php?admin=settings''>Das Menü Einstellungen</a> können Sie wichtige Einstellungen für die Site zu definieren.</p><p><b>•</b> Im <a href=''index.php?admin=my_account''>Ihr Konto</a> gibt es eine Möglichkeit, um Ihre Daten ändern.</p><p><b>•</b> <a href=''index.php?admin=menus''>Menüs</a> und <a href=''index.php?admin=pages''>Seiten-Management</a> sind zur Erstellung und Verwaltung Menüs, Links und Seiten gestaltet.</p><p><b>•</b> So erstellen und bearbeiten Zimmertypen, Verfügbarkeiten, Preise, Buchungen und weitere Info zum Wohnungen, verwenden <a href=''index.php?admin=hotels_info''>Wohnungen Management</a> und <a href=''index.php?admin=mod_booking_bookings''>Buchungen</a> Menüs.</p>'),
(NULL, 'en', '_FLATS_AGENT_COMMISION', 'Flats Owner/Agent Commision'),
(NULL, 'es', '_FLATS_AGENT_COMMISION', 'Pisos Propietario/Agente Commision'),
(NULL, 'de', '_FLATS_AGENT_COMMISION', 'Wohnungen Management/Agent Provision'),
(NULL, 'en', '_FLATS_ALERT_SAME_HOTEL_ROOMS', 'You can add only one flats to this basket!'),
(NULL, 'es', '_FLATS_ALERT_SAME_HOTEL_ROOMS', '¡Sólo puedes añadir un piso a esta canasta!'),
(NULL, 'de', '_FLATS_ALERT_SAME_HOTEL_ROOMS', 'Sie können nur eine Wohnung zu diesem Korb hinzufügen!'),
(NULL, 'en', '_COUPON_FOR_SINGLE_FLAT_ALERT', 'This discount coupon can be applied only for single flat!'),
(NULL, 'es', '_COUPON_FOR_SINGLE_FLAT_ALERT', 'Este cupón de descuento se puede aplicar sólo para un solo piso!'),
(NULL, 'de', '_COUPON_FOR_SINGLE_FLAT_ALERT', 'Dieser Rabattgutschein kann nur für einzelne Wohnung angewendet werden!'),
(NULL, 'en', '_FLATS_DIRECT_RESERVATION', 'Direct reservation with flats, No booking fees'),
(NULL, 'es', '_FLATS_DIRECT_RESERVATION', 'Reserva directa con hotel, Sin gastos de reserva'),
(NULL, 'de', '_FLATS_DIRECT_RESERVATION', 'Direkte Reservierung mit dem Hotel, Keine Buchungsgebühren'),
(NULL, 'en', '_FLATS_DISCOUNT_CAMPAIGN_TEXT', '<span class=campaign_header>Super discount campaign!</span><br /><br />\r\nEnjoy special price cuts right now<br />_FROM_ _TO_:<br /> \r\n<b>_PERCENT_</b> on booking our apartment!'),
(NULL, 'es', '_FLATS_DISCOUNT_CAMPAIGN_TEXT', '<span class=campaign_header>Super campaña de descuento!</span><br /><br />\r\nDisfrute de los recortes de precios especiales en este momento <br />_FROM_ _TO_:<br /><b>_PERCENT_</b> en la reserva de nuestro apartamento!'),
(NULL, 'de', '_FLATS_DISCOUNT_CAMPAIGN_TEXT', '<span class=campaign_header>Super Rabattaktion!</span> <br /><br />Genießen Sie besondere Preissenkungen jetzt <br />_FROM_ _TO_: <br /> <b>_PERCENT_</b> Bei der Buchung unserer Wohnung!'),
(NULL, 'en', '_DISTANCE_OF_FLAT_FROM_CENTER_POINT', 'Distance of the flat to the {name_center_point} is {distance_center_point}'),
(NULL, 'es', '_DISTANCE_OF_FLAT_FROM_CENTER_POINT', 'La distancia del plano al {name_center_point} es {distance_center_point}'),
(NULL, 'de', '_DISTANCE_OF_FLAT_FROM_CENTER_POINT', 'Die Entfernung des Hotels vom {name_center_point} ist {distance_center_point}'),
(NULL, 'en', '_EX_FLAT_OR_LOCATION', 'e.g. flat, landmark or location'),
(NULL, 'es', '_EX_FLAT_OR_LOCATION', 'p.ej. Apartamento, punto de referencia o ubicación'),
(NULL, 'de', '_EX_FLAT_OR_LOCATION', 'z.B. Flach, landmark oder standort'),
(NULL, 'en', '_FOUND_FLATS', 'Found Flats'),
(NULL, 'es', '_FOUND_FLATS', 'Pisos encontrados'),
(NULL, 'de', '_FOUND_FLATS', 'Gefundene Wohnungen'),
(NULL, 'en', '_FLAT', 'Flat'),
(NULL, 'es', '_FLAT', 'Plano'),
(NULL, 'de', '_FLAT', 'Wohnung'),
(NULL, 'en', '_FLATS_HOTELOWNER_WELCOME_TEXT', 'Welcome to Flats Owner Control Panel! With this Control Panel you can easily manage your flats, customers, reservations and perform a full hotel site management.'),
(NULL, 'es', '_FLATS_HOTELOWNER_WELCOME_TEXT', 'Bienvenido al panel de control de Flats! Con este panel de control puede gestionar fácilmente sus pisos, clientes, reservas y realizar una gestión completa del sitio del hotel.'),
(NULL, 'de', '_FLATS_HOTELOWNER_WELCOME_TEXT', 'Willkommen bei Flats Owner Control Panel! Mit diesem Control Panel können Sie ganz einfach verwalten Sie Ihre Wohnungen, Kunden, Reservierungen und führen eine komplette Hotel-Site-Management.'),
(NULL, 'en', '_FLATS', 'Flats'),
(NULL, 'es', '_FLATS', 'Pisos'),
(NULL, 'de', '_FLATS', 'Wohnungen'),
(NULL, 'en', '_FLATS_INFO', 'Flats Info'),
(NULL, 'es', '_FLATS_INFO', 'Pisos Info'),
(NULL, 'de', '_FLATS_INFO', 'Flats Info'),
(NULL, 'en', '_FLATS_MANAGEMENT', 'Flats Management'),
(NULL, 'es', '_FLATS_MANAGEMENT', 'Gestión de pisos'),
(NULL, 'de', '_FLATS_MANAGEMENT', 'Flats Management'),
(NULL, 'en', '_FLAT_DELETE_ALERT', 'Are you sure you want to delete this flat? Remember: after completing this action all related data to this flat could not be restored!'),
(NULL, 'es', '_FLAT_DELETE_ALERT', '¿Seguro que quieres eliminar este apartamento? Recuerde: después de completar esta acción, todos los datos relacionados a este piso no pudieron ser restaurados.'),
(NULL, 'de', '_FLAT_DELETE_ALERT', 'Bist du sicher, dass du diese Wohnung löschen möchtest? Denken Sie daran: Nach Abschluss dieser Aktion konnten alle verwandten Daten zu dieser Wohnung nicht wiederhergestellt werden!'),
(NULL, 'en', '_FLAT_DESCRIPTION', 'Flat Description'),
(NULL, 'es', '_FLAT_DESCRIPTION', 'Piso Descripción'),
(NULL, 'de', '_FLAT_DESCRIPTION', 'Flache Beschreibung'),
(NULL, 'en', '_FLAT_FACILITIES', 'Flats Facilities'),
(NULL, 'es', '_FLAT_FACILITIES', 'Instalaciones de Pisos'),
(NULL, 'de', '_FLAT_FACILITIES', 'Wohnungen Einrichtungen'),
(NULL, 'en', '_FLAT_INFO', 'Flats Info'),
(NULL, 'es', '_FLAT_INFO', 'Pisos Info'),
(NULL, 'de', '_FLAT_INFO', 'Flats Info'),
(NULL, 'en', '_FLAT_MANAGEMENT', 'Flats Management'),
(NULL, 'es', '_FLAT_MANAGEMENT', 'Gestión de pisos'),
(NULL, 'de', '_FLAT_MANAGEMENT', 'Flats Management'),
(NULL, 'en', '_FLAT_OWNER', 'Flat Owner'),
(NULL, 'es', '_FLAT_OWNER', 'Propietario plano'),
(NULL, 'de', '_FLAT_OWNER', 'Wohnung Inhaber'),
(NULL, 'en', '_FLAT_OWNERS', 'Flat Owners'),
(NULL, 'es', '_FLAT_OWNERS', 'Propietarios de Flat'),
(NULL, 'de', '_FLAT_OWNERS', 'Wohnungseigentümer'),
(NULL, 'en', '_FLAT_PAYMENT_GATEWAYS', 'Flats Payment Gateways'),
(NULL, 'es', '_FLAT_PAYMENT_GATEWAYS', 'Pago Pago Gateways'),
(NULL, 'de', '_FLAT_PAYMENT_GATEWAYS', 'Flats Payment Gateways'),
(NULL, 'en', '_FLAT_RESERVATION_ID', 'Flat Reservation ID'),
(NULL, 'es', '_FLAT_RESERVATION_ID', 'ID de reserva plana'),
(NULL, 'de', '_FLAT_RESERVATION_ID', 'Flat Reservierungs-ID'),
(NULL, 'en', '_LAST_FLAT_ALERT', 'You cannot delete last active flats record!'),
(NULL, 'es', '_LAST_FLAT_ALERT', '¡No puede borrar el último registro activo de pisos!'),
(NULL, 'de', '_LAST_FLAT_ALERT', 'Du kannst den letzten aktiven Bonus nicht löschen!'),
(NULL, 'en', '_LAST_FLAT_PROPERTY_ALERT', 'This property type cannot be deleted, because it is participating in one property at least.'),
(NULL, 'es', '_LAST_FLAT_PROPERTY_ALERT', 'Este tipo de propiedad no puede ser eliminado, ya que está participando en un establecimiento al menos.'),
(NULL, 'de', '_LAST_FLAT_PROPERTY_ALERT', 'Diese Eigenschaft Typ kann nicht gelöscht werden, weil sie in einer Eigenschaft zumindest beteiligt.'),
(NULL, 'en', '_TARGET_FLAT', 'Target Flat'),
(NULL, 'es', '_TARGET_FLAT', 'Target Flat'),
(NULL, 'de', '_TARGET_FLAT', 'Zielflache'),
(NULL, 'en', '_YOU_NOT_REVIEW_THIS_FLAT', 'Sorry, but you can''t leave a review for this flat, you''ve never been there'),
(NULL, 'es', '_YOU_NOT_REVIEW_THIS_FLAT', 'Lo sentimos, pero no puedes dejar un comentario para este piso, nunca has estado allí'),
(NULL, 'de', '_YOU_NOT_REVIEW_THIS_FLAT', 'Tut mir leid, aber du kannst keine Bewertung für diese Wohnung hinterlassen, du warst noch nie dort'),
(NULL, 'en', '_SELECT_FLAT', 'Select Flat'),
(NULL, 'es', '_SELECT_FLAT', 'Seleccione plano'),
(NULL, 'de', '_SELECT_FLAT', 'Wohnung auswählen'),
(NULL, 'en', '_SELECT_DESTINATION_OR_FLAT', 'Destination / Flat Name'),
(NULL, 'es', '_SELECT_DESTINATION_OR_FLAT', 'Nombre del destino / plano'),
(NULL, 'de', '_SELECT_DESTINATION_OR_FLAT', 'Ziel / flacher Name'),
(NULL, 'en', '_FLAT_WITH_BEST_PRICE', 'Flat with the best price'),
(NULL, 'es', '_FLAT_WITH_BEST_PRICE', 'Apartamento con el mejor precio'),
(NULL, 'de', '_FLAT_WITH_BEST_PRICE', 'Wohnung mit dem besten Preis'),
(NULL, 'en', '_LAST_BOOKING_FLAT_WAS', 'Last booking for this flat was {type_booking}'),
(NULL, 'es', '_LAST_BOOKING_FLAT_WAS', 'La última reserva para este piso fue {type_booking}'),
(NULL, 'de', '_LAST_BOOKING_FLAT_WAS', 'Letzte Buchung für diese Wohnung war {type_booking}'),
(NULL, 'en', '_THIS_FLAT', 'this flat'),
(NULL, 'es', '_THIS_FLAT', 'este piso'),
(NULL, 'de', '_THIS_FLAT', 'diese Wohnung'),
(NULL, 'en', '_OUR_FLATS', 'our flats'),
(NULL, 'es', '_OUR_FLATS', 'nuestros pisos'),
(NULL, 'de', '_OUR_FLATS', 'unsere Wohnungen'),
(NULL, 'en', '_DEFAULT_FLAT_DELETE_ALERT', 'You cannot delete default flat!'),
(NULL, 'es', '_DEFAULT_FLAT_DELETE_ALERT', 'No puedes eliminar el plano predeterminado!'),
(NULL, 'de', '_DEFAULT_FLAT_DELETE_ALERT', 'Sie können nicht standardmäßig flach löschen!'),
(NULL, 'en', '_OWNER_NOT_ASSIGNED_TO_FLAT', 'Wrong flat ID or you have no access permissions to view it.'),
(NULL, 'es', '_OWNER_NOT_ASSIGNED_TO_FLAT', 'Identificación plana incorrecta o no tiene permisos de acceso para verla.'),
(NULL, 'de', '_OWNER_NOT_ASSIGNED_TO_FLAT', 'Falsche Flat ID oder Sie haben keine Zugriffsberechtigungen, um sie anzusehen.'),
(NULL, 'en', '_PC_FLAT_INFO_TEXT', 'information about flat: name, address, telephone, fax etc.'),
(NULL, 'es', '_PC_FLAT_INFO_TEXT', 'información sobre piso: nombre, dirección, teléfono, fax, etc.'),
(NULL, 'de', '_PC_FLAT_INFO_TEXT', 'Informationen über Wohnung: Name, Adresse, Telefon, Fax etc.'),
(NULL, 'en', '_REGIONAL_NOT_FLATS', 'There are no flats found in your location. You cannot see reports.'),
(NULL, 'es', '_REGIONAL_NOT_FLATS', 'No hay pisos encontrados en su ubicación. No puede ver los informes.'),
(NULL, 'de', '_REGIONAL_NOT_FLATS', 'Es gibt keine Wohnungen in deinem Standort gefunden. Sie können keine Berichte sehen.'),
(NULL, 'en', '_MOST_POPULAR_FLATS', 'Most Popular Flats'),
(NULL, 'es', '_MOST_POPULAR_FLATS', 'Apartamentos más populares'),
(NULL, 'de', '_MOST_POPULAR_FLATS', 'Beliebteste Wohnungen');

-- 08/14/2017 --
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES
(NULL, 'en', '_FLAT_COMFORT', 'Flats Comfort'),
(NULL, 'es', '_FLAT_COMFORT', 'Apartamentos confort'),
(NULL, 'de', '_FLAT_COMFORT', 'Wohnungen Komfort'),
(NULL, 'en', '_FLAT_AREA', 'Apartment Area'),
(NULL, 'es', '_FLAT_AREA', 'Apartamento'),
(NULL, 'de', '_FLAT_AREA', 'Wohnung Bereich'),
(NULL, 'en', '_MESSAGE_INFO_LINK_BOOKING', 'You can go to the order by clicking the <a href=''index.php?page=booking''>"booking"</a> link in the footer menu'),
(NULL, 'es', '_MESSAGE_INFO_LINK_BOOKING', 'Puede ir a la orden haciendo clic en el enlace <a href=''index.php?page=booking''>"reserva"</a> en el menú de pie de página'),
(NULL, 'de', '_MESSAGE_INFO_LINK_BOOKING', 'Sie können in den Auftrag gehen, indem Sie im Footer-Menü auf den Link <a href=''index.php?page=booking''>"Buchung"</a> klicken');

-- 08/17/2017 --
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES
(NULL, 'en', '_FLAT_WAS_ADDED', 'Flat has been successfully added to your reservation!'),
(NULL, 'es', '_FLAT_WAS_ADDED', 'Apartamento ha sido añadido a su reserva con éxito!'),
(NULL, 'de', '_FLAT_WAS_ADDED', 'Flat wurde erfolgreich zu Ihrer Reservierung hinzugefügt!'),
(NULL, 'en', '_FLAT_WAS_REMOVED', 'Selected flat has been removed from your Reservation Cart!'),
(NULL, 'es', '_FLAT_WAS_REMOVED', 'El apartamento seleccionado ha sido eliminado de su Carrito de Reservas!'),
(NULL, 'de', '_FLAT_WAS_REMOVED', 'Ausgewählte Wohnung wurde aus Ihrem Reservierungswagen entfernt!'),
(NULL, 'en', '_FLAT_NOT_FOUND', 'Flat has not been found!'),
(NULL, 'es', '_FLAT_NOT_FOUND', 'Apartamento no ha sido encontrado!'),
(NULL, 'de', '_FLAT_NOT_FOUND', 'Wohnung wurde nicht gefunden!'),
(NULL, 'en', '_SELECTED_FLATS', 'Selected Flats'),
(NULL, 'es', '_SELECTED_FLATS', 'Pisos seleccionados'),
(NULL, 'de', '_SELECTED_FLATS', 'Ausgewählte Wohnungen'),
(NULL, 'de', '_DELETE_ALL', 'Alles löschen'),
(NULL, 'en', '_DELETE_ALL', 'Delete all'),
(NULL, 'es', '_DELETE_ALL', 'Eliminar todos'),
(NULL, 'de', '_DELETE_ALL_ALERT', 'Sind Sie sicher, dass Sie alle Datensätze löschen möchten? Denken Sie daran: Nach dem Abschluss dieser Aktion können die Daten nicht wiederhergestellt werden!'),
(NULL, 'en', '_DELETE_ALL_ALERT', 'Are you sure you want to delete all records? Remember: after the completion of this action, the data cannot be restored!'),
(NULL, 'es', '_DELETE_ALL_ALERT', '¿Seguro que desea eliminar todos los registros? Recuerde: después de la finalización de esta acción, los datos no se pueden restaurar!');

-- 09/20/2017 --
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES
(NULL, 'de', '_HOTEL_RESTRICTIONS_MIN_MAX_ROOMS', 'Bei der Buchung in <b>_HOTEL_NAME_</b> Hotel gibt es Einschränkungen in der Anzahl der Zimmer reserviert.<br> Sie müssen mindestens <b>_MIN_ROOMS_</b> und nicht mehr als <b>_MAX_ROOMS_</b>'),
(NULL, 'en', '_HOTEL_RESTRICTIONS_MIN_MAX_ROOMS', 'When booking in <b>_HOTEL_NAME_</b> hotel there are restrictions in the number of rooms reserved.<br> They must be at least <b>_MIN_ROOMS_</b> and not more than <b>_MAX_ROOMS_</b>'),
(NULL, 'es', '_HOTEL_RESTRICTIONS_MIN_MAX_ROOMS', 'Al reservar en <b>_HOTEL_NAME_</b> hotel hay restricciones en el número de habitaciones reservadas.<br> Deberán tener un mínimo de <b>_MIN_ROOMS_</b> y no más de <b>_MAX_ROOMS_</b>'),
(NULL, 'de', '_HOTEL_RESTRICTIONS_MIN_ROOMS', 'Bei der Buchung in <b>_HOTEL_NAME_</b> Hotel gibt es Einschränkungen in der Anzahl der Zimmer reserviert.<br> Sie müssen mindestens <b>_MIN_ROOMS_</b>'),
(NULL, 'en', '_HOTEL_RESTRICTIONS_MIN_ROOMS', 'When booking in <b>_HOTEL_NAME_</b> hotel there are restrictions in the number of rooms reserved.<br> They must be at least <b>_MIN_ROOMS_</b>'),
(NULL, 'es', '_HOTEL_RESTRICTIONS_MIN_ROOMS', 'Al reservar en <b>_HOTEL_NAME_</b> hotel hay restricciones en el número de habitaciones reservadas.<br> Deben ser por lo menos <b>_MIN_ROOMS_</b>'),
(NULL, 'de', '_HOTEL_RESTRICTIONS_MAX_ROOMS', 'Bei der Buchung in <b>_HOTEL_NAME_</b> Hotel gibt es Einschränkungen in der Anzahl der Zimmer reserviert.<br> Sie müssen nicht mehr sein als <b>_MAX_ROOMS_</b>'),
(NULL, 'en', '_HOTEL_RESTRICTIONS_MAX_ROOMS', 'When booking in <b>_HOTEL_NAME_</b> hotel there are restrictions in the number of rooms reserved.<br> They must be at not more than <b>_MAX_ROOMS_</b>'),
(NULL, 'es', '_HOTEL_RESTRICTIONS_MAX_ROOMS', 'Al reservar en <b>_HOTEL_NAME_</b> hotel hay restricciones en el número de habitaciones reservadas.<br> Deben estar a no más de <b>_MAX_ROOMS_</b>');

-- 09/22/2017 --
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES
(NULL, 'de', '_CANNOT_BOOKING_MORE', 'Sie können nicht mehr als <b>_NUM_ROOMS_</b> Zimmer buchen.'),
(NULL, 'en', '_CANNOT_BOOKING_MORE', 'You cannot order more than <b>_NUM_ROOMS_</b> rooms.'),
(NULL, 'es', '_CANNOT_BOOKING_MORE', 'No se puede reservar más de <b>_NUM_ROOMS_</b> habitaciones.'),
(NULL, 'de', '_CONTINUE_MUST_BOOK_MIN', 'Bei der Buchung müssen Sie mindestens <b>_NUM_ROOMS_</b> Zimmer buchen'),
(NULL, 'en', '_CONTINUE_MUST_BOOK_MIN', 'In booking to continue you must book a minimum of <b>_NUM_ROOMS_</b> rooms'),
(NULL, 'es', '_CONTINUE_MUST_BOOK_MIN', 'En la reserva para continuar debe reservar un mínimo de <b>_NUM_ROOMS_</b> habitaciones');

-- 10/08/2017 --
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES
(NULL, 'en', '_UPDATE_CURRENCY_RATE', 'Update Currency Rates'), (NULL, 'es', '_UPDATE_CURRENCY_RATE', 'Actualizar tipo de cambio'), (NULL, 'de', '_UPDATE_CURRENCY_RATE', 'Währungskurs aktualisieren'),
(NULL, 'en', '_CURRENCY_PREVIOUS_RATE', 'Previous Rate'), (NULL, 'es', '_CURRENCY_PREVIOUS_RATE', 'Tarifa anterior'), (NULL, 'de', '_CURRENCY_PREVIOUS_RATE', 'Vorheriger Preis'),
(NULL, 'en', '_CURRENCY_NEW_RATE', 'New Rate'), (NULL, 'es', '_CURRENCY_NEW_RATE', 'Nueva tarifa'), (NULL, 'de', '_CURRENCY_NEW_RATE', 'Neuer Tarif'),
(NULL, 'en', '_NO_CHANGES', 'no changes'), (NULL, 'es', '_NO_CHANGES', 'sin cambios'), (NULL, 'de', '_NO_CHANGES', 'keine Änderungen'),
(NULL, 'en', '_LAST_UPDATE', 'Last Update'), (NULL, 'es', '_LAST_UPDATE', 'Última actualización'), (NULL, 'de', '_LAST_UPDATE', 'Letztes Update'),
(NULL, 'en', '_FIELD_MUST_BE_DATE', '_FIELD_ must be in valid date format! Please re-enter.'),
(NULL, 'es', '_FIELD_MUST_BE_DATE', '_FIELD_ debe estar en formato de fecha válido! Por favor, vuelva a entrar.'),
(NULL, 'de', '_FIELD_MUST_BE_DATE', '_FIELD_ müssen in gültigen Datum-Format! Bitte erneut eingeben.'),
(NULL, 'en', '_ADMIN_ANSWER', 'Admin Answer'),
(NULL, 'es', '_ADMIN_ANSWER', 'Respuesta del administrador'),
(NULL, 'de', '_ADMIN_ANSWER', 'Admin Antwort'),
(NULL, 'en', '_IT_IS_YOUR_REVIEW', 'it''s your review'),
(NULL, 'es', '_IT_IS_YOUR_REVIEW', 'es tu opinión'),
(NULL, 'de', '_IT_IS_YOUR_REVIEW', 'es ist deine Überprüfung'),
(NULL, 'en', '_QUICK_RESERVATIONS_MSG', 'Quick Reservations feature allows quick reserving rooms without specifying the guest name.'),
(NULL, 'es', '_QUICK_RESERVATIONS_MSG', 'La función de reservas rápidas permite reservar salas rápidamente sin especificar el nombre del huésped'),
(NULL, 'de', '_QUICK_RESERVATIONS_MSG', 'Die Schnellreservierungsfunktion ermöglicht die schnelle Reservierung von Räumen ohne Angabe des Gastnamens'),
(NULL, 'en', '_ERROR', 'Error'),
(NULL, 'es', '_ERROR', 'Error'),
(NULL, 'de', '_ERROR', 'Fehler'),
(NULL, 'de', '_EMAIL_TEMPLATE', 'E-Mail-Vorlagen'),
(NULL, 'en', '_EMAIL_TEMPLATE', 'Email Template'),
(NULL, 'es', '_EMAIL_TEMPLATE', 'Plantillas de correo');

-- 27/11/2017 --
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES
(NULL, 'de', '_VEHICLE', 'Fahrzeug'), (NULL, 'en', '_VEHICLE', 'Vehicle'), (NULL, 'es', '_VEHICLE', 'Vehículo'),
(NULL, 'de', '_VEHICLES', 'Fahrzeuge'), (NULL, 'en', '_VEHICLES', 'Vehicles'), (NULL, 'es', '_VEHICLES', 'Vehículos');

-- 10/12/2017 --
INSERT INTO `<DB_PREFIX>vocabulary` (`id`, `language_id`, `key_value`, `key_text`) VALUES
(NULL, 'de', '_TOKEN_EXPIRED_ALERT', 'Token ist abgelaufen. Bitte laden Sie die Seite neu und versuchen Sie es erneut.'),
(NULL, 'en', '_TOKEN_EXPIRED_ALERT', 'Token expired. Please reload page and try again.'),
(NULL, 'es', '_TOKEN_EXPIRED_ALERT', 'Token expiró. Por favor, recarga la página e intenta nuevamente.');
