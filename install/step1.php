                ...
                <tr>
                    ...
                    <td align="middle">
						...
						<tr>
							...
							<td>
								<input type="password" class="form_text" name="database_password" size="30" value="<?php echo $database_password; ?>" autocomplete="off" />
						...
						<tr>
							...
							<td>
								<select name="install_type" onchange="install_type_OnChange(this.value)">
									<option value="new" <?php echo ($install_type == 'new') ? 'checked="checked"' : ''; ?>>Fresh installation</option>
									<?php
						...
						<tr>
							...
							<td class="text"><input name="password" type="password" size="28" maxlength="32" value="" autocomplete='off' /> <?php if(EI_MODE == 'demo'){ ?> (demo: test) <?php } ?></td>
						</tr>
						<tr>
							<td>&nbsp;Admin Email (optional)</td>
							<td class="text"><input name="email" type="text" size="28" maxlength="70" value="" autocomplete='off' /> <?php if(EI_MODE == 'demo'){ ?> (demo: test@email.me) <?php } ?></td>
						</tr>
