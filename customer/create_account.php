...
?>
	...
	<form action="index.php?customer=create_account" method="post" name="frmRegistration" id="frmRegistration">
		...
		<tr>
			<td width="38%" align="<?php echo $align_right; ?>"><?php echo _FIRST_NAME;?></td>
		...
		<tr>
			<td align="<?php echo $align_right; ?>"><?php echo _LAST_NAME;?></td>
			<td><span class="mandatory_star">*</span></td>
		...
		<tr>
			<td align="<?php echo $align_right; ?>"><?php echo _BIRTH_DATE;?></td>
			<td>&nbsp;</td>
			<td nowrap="nowrap">
		...
		<tr>
			<td align="<?php echo $align_right; ?>"><?php echo _COMPANY;?></td>
			<td>&nbsp;</td>
		...
		<tr>
			<td align="<?php echo $align_right; ?>"><?php echo _ADDRESS;?></td>
			<td><span class="mandatory_star">*</span></td>
		...
		<tr>
			<td align="<?php echo $align_right; ?>"><?php echo _ADDRESS_2;?></td>
			<td>&nbsp;</td>
		...
		<tr>
			<td align="<?php echo $align_right; ?>"><?php echo _COUNTRY;?></td>
			<td><span class="mandatory_star">*</span></td>
			<td nowrap="nowrap">
		...
		<tr>
			<td align="<?php echo $align_right; ?>"><?php echo _STATE_PROVINCE;?></td>
			<td></td>
		...
		<tr>
			<td align="<?php echo $align_right; ?>"><?php echo _USERNAME;?></td>
			<td><span class="mandatory_star">*</span></td>
		...
		<tr>
			<td align="<?php echo $align_right; ?>"><?php echo _PASSWORD;?></td>
			<td><span class="mandatory_star">*</span></td>
		...
		<tr>
			<td align="<?php echo $align_right; ?>"><?php echo _CONFIRM_PASSWORD;?></td>
			<td><span class="mandatory_star">*</span></td>
		...
		<tr>
			<td colspan="3" align="<?php echo $align_left; ?>">
			<table>
			<tr valign="top">
				<td align="<?php echo $align_right; ?>"><input type='checkbox' name="send_updates" id="send_updates" <?php echo (($send_updates == '1') ? 'checked="checked"' : '');?> value="1"></td>
				<td>&nbsp;</td>
				<td><?php echo _NOTIFICATION_MSG; ?></td>
			</tr>
			<tr><td colspan="3" nowrap="nowrap" height="5px"></td></tr>
			<tr valign="middle">
				<td align="<?php echo $align_right; ?>"><input type="checkbox" name="agree" id="agree" value="1" <?php echo ($agree == '1') ? 'checked="checked"' : ''; ?>></td>
				<td>&nbsp;</td>
				<td>
				<?php
