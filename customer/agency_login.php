...
if(!$objLogin->IsLoggedIn() && ModulesSettings::Get('customers', 'allow_login') == 'yes' && ModulesSettings::Get('customers', 'allow_agencies') == 'yes'){
	...
	draw_content_start();	
?>
	<form class="login-form" action="index.php?customer=<?php echo TRAVEL_AGENCY_LOGIN; ?>" method="post">
...
?>
	...
	<form action="index.php?customer=<?php echo TRAVEL_AGENCY_LOGIN; ?>" method="post">
